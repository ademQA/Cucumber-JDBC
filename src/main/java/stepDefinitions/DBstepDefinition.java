...
public class DBstepDefinition {
    ...
    @Given("Student tablosu icin query hazırlanır")
    public void student_tablosu_icin_query_hazırlanır() throws SQLException {
        resultSet = statement.executeQuery(ConfigReader.getProperty("queryodev1"));
    }

    @Given("Student tablosu sonuclari dogrulanir")
    public void student_tablosu_sonuclari_dogrulanir() throws SQLException {
        resultSet.next();
    ...
    //-------------------odev 2-----------------
    @Given("student tablosundaki ilgili query hazirlanir")
    public void student_tablosundaki_ilgili_query_hazirlanir() throws SQLException {

        resultSet=statement.executeQuery(ConfigReader.getProperty("queryodev2"));
    }
    @Given("Student tablosundaki gerekli testler dogrulanir")
    public void student_tablosundaki_gerekli_testler_dogrulanir() throws SQLException {
